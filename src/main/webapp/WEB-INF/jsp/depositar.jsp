...
<div class="container">
    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <form:form method="POST" action="depositar" modelAttribute="movForm" class="form-signin">
                <div class="form-group">
                    <label for="valor">
                        Digite o valor do depósito a ser feito:
                    </label>
                    <form:input path="valor" class="form-control"></form:input>
                    <form:hidden path="conta" value="${conta.id}"></form:hidden>
                </div>
